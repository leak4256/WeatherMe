...
export class WeatherService {
  ...
  //Cumputes the temperature value and unit according the unit.
  getTemperatureString(currentWeather:CurrentWeather): string {
   return this.isMetric ? currentWeather[0].Temperature.Metric.Value + '°C' : currentWeather[0].Temperature.Imperial.Value + '°F'
  }
